...
<div id="header">
    ...
    <div id="logo">
        ...
        <p><span class="slogan">admin page</span></p>
    </div>
    ...
    <div id="main-content">
        ...
        <div id="content-1">
            <div class="featured">
                ...
                <c:if test="${currentUser.role.name() == adminRole}">
                    <p>
                        <b>Choose data to manage:</b><br>
                        <a href="<c:url value="/admin/viewAllUsers"/>">Users data</a><br>
                        <a href="<c:url value="/admin/stationsPage"/>">Stations data</a><br>
                        <a href="<c:url value="/admin/trainsPage"/>">Trains data</a><br>
